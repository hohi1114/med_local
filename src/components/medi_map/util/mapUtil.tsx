...
const messageMap: Record<Key, string> = {
  ...
  high_high_low:
    "신규 유입은 활발하지만 재방문이 부족해요. 만족도나 재방문 안내가 아쉬울 수 있어요.",

  high_mid_high:
    "충성도 높은 고객층이 확보된 상태에요. 추가 유입을 늘릴 방법을 좀 더 고민해보면 좋을 것 같아요.",
  high_mid_mid: "안정적이고 천천히 성장하고 있어요.",
  high_mid_low: "매출은 성장하고 있지만 기존 고객 이탈이 늘어났어요.",

  high_low_high:
    "재방문은 활발하지만 신규 유입이 눈에 띄게 줄었어요. 마케팅 현황을 한번 점검해보시겠어요?",
  high_low_mid: "신환이 많이 줄었고, 재방문도 조금 더 보완이 필요해요.",
  high_low_low:
    "매출은 늘었지만, 신규 유입도 적고 재진율도 낮아서 불안정한 구조에요. 전반적인 점검이 필요합니다.",

  // 매출 MID
  mid_high_high:
    "신규 유입과 재방문 모두 활발해요. 성장가능성이 높은 지역입니다.",
  mid_high_mid:
    "유입은 높지만 재방문으로 이어지는 비율이 높지 않아요. 다음 방문을 조금 더 신경써 보는건 어떨까요?",
  mid_high_low:
    "유입에 비해 재진율이 크게 떨어지고 있어요. 내부 점검이 필요할 것 같아요.",

  mid_mid_high:
    "유입은 보통이지만 병원에 대한 신뢰도가 높아요. 입소문이나 후기를 통한 신규 유입 전략을 추천 드려요.",
  mid_mid_mid:
    "유입과 재방문 모두 큰 변화가 없어요. 새로운 마케팅을 시도해보시는 건 어떨까요?",
  mid_mid_low:
    "유입 대비 재방문이 낮아요. 내부 점검을 한번 해보시는 건 어떨까요?",

  mid_low_high:
    "신규 유입만 늘어나면 빠르게 성장할 수 있는 구조에요. 마케팅에 적극적으로 나서보세요!",
  mid_low_mid: "유입과 재진 모두 흔들리고 있어요. 마케팅 상황을 점검해보세요.",
  mid_low_low:
    "유입과 재방문 모두 눈에 띄게 줄었어요. 마케팅 현황에 대한 전반적인 점검이 필요합니다.",

  // 매출 LOW
  low_high_high:
    "객단가가 크게 떨어진 것 같아요. 상품 구성을 점검해보시는 건 어떨까요?",
  low_high_mid: "유입은 높지만 수익성이 크게 떨어지는 것 같아요.",
  low_high_low: "신규 유입 대비 이탈이 많아요. 경험 설계 개선이 필요해 보여요.",

  low_mid_high: "충성도 높은 고객은 있지만, 신환 유입이 조금 더 필요해요.",
  low_mid_mid:
    "신규 유입과 재방문율 모두 중간이에요. 조금 더 공격적인 마케팅을 해보는건 어떨까요?",
  low_mid_low:
    "재진율이 크게 줄어들었어요. 고객 경험에 대한 전반적인 점검이 필요해요",

  low_low_high:
    "충성도는 있지만, 유입이 너무 적어요. 마케팅이 환자에게 잘 닿고 있지 않아요.",
  low_low_mid:
    "신환이 크게 줄어 매출이 많이 감소했어요. 마케팅 전략의 전반적인 수정이 필요해요.",
  low_low_low:
    "신환과 재진 모두 크게 감소했어요. 전면적인 전략 수정이 필요합니다."
};
